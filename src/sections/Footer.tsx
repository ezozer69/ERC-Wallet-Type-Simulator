...
import { Wallet, MapPin, Phone, Mail, Instagram, Facebook, Twitter, Youtube, Linkedin, Github, ArrowUp, CheckCircle } from 'lucide-react';
import { footerConfig } from '../config';

// Icon lookup map for dynamic icon resolution from config strings
const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
  Wallet, MapPin, Phone, Mail, Instagram, Facebook, Twitter, Youtube, Linkedin, Github, ArrowUp,
};
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <Wallet className="w-8 h-8 text-gold-500" aria-hidden="true" />
              <div>
