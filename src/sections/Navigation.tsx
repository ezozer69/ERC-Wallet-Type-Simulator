...
import { Menu, X, ChevronDown, Wallet, Home, BookOpen, Newspaper, Users, Mail, Grape, Shield, Sparkles, Github } from 'lucide-react';
import { navigationConfig } from '../config';

// Icon lookup map for dynamic icon resolution from config strings
const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
  Home, BookOpen, Newspaper, Users, Mail, Grape, Wallet, Shield, Sparkles, Github, Menu, X, ChevronDown,
};
  ...
  return (
    ...
    >
      <div className="container-custom flex items-center justify-between">
        ...
        >
          <Wallet className="w-8 h-8 text-gold-500 transition-transform duration-300 group-hover:scale-110" aria-hidden="true" />
